                ...
                <Card variant="outlined">
                    <CardContent>
                        <FormGroup>
                            ...
                            <FormControlLabel control={<Checkbox name="Person2" checked={cchecked.Person2} onChange={handlechange} color={colorprops.color3} />}
                                label="Person 2" sx={{ '& .MuiSvgIcon-root': { fontSize: 28 } }} />
                            <FormControlLabel control={<Checkbox name="Person3" checked={cchecked.Person3} onChange={handlechange} color={colorprops.color1} />}
                                label="Person 3" sx={{ '& .MuiSvgIcon-root': { fontSize: 28 } }} />
                            <FormControlLabel control={<Checkbox name="Person4" checked={cchecked.Person4} onChange={handlechange} color={colorprops.color4} />}
